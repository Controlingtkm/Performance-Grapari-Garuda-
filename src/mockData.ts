...
export const initialKpiCs: KpiCsRecord[] = [
  {
    ...
    roleplay: 95,
    achievement: 98.5,
    notes: 'Rank #1 CSR. Penjualan Halo (22) & IndiHome (7), Productivity 254, TNPS 100%, Churn Mobile 100%.',
    ranking: 1,
    progress: 60,
    target: 48,
    status: 'Excellent',
  ...
  },
  {
    ...
    roleplay: 92,
    achievement: 94.2,
    notes: 'Rank #2 CSR. Productivity 261 pelanggan. Churn Prevention Mobile 100% & DO IH 9.',
    ranking: 2,
    progress: 35,
    target: 48,
    status: 'Excellent',
  ...
  },
  {
    ...
    roleplay: 90,
    achievement: 92.4,
    notes: 'Rank #3 CSR. Revenue FIVAS tertinggi Rp 2.926.500. TNPS 100% & RR FIX 91%.',
    ranking: 3,
    progress: 58,
    target: 48,
    status: 'Good',
  ...
  },
  {
    ...
    roleplay: 88,
    achievement: 88.4,
    notes: 'Rank #4 CSR. Retensi IndiHome tertinggi (88) & RR Fix 95%.',
    ranking: 4,
    progress: 42,
    target: 48,
    status: 'Good',
  ...
  },
  {
    ...
    roleplay: 85,
    achievement: 82.0,
    notes: 'Rank #5 CSR. Promotor TNPS 6, DO IH 11.',
    ranking: 5,
    progress: 35,
    target: 48,
