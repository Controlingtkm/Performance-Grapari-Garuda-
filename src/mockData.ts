...
export const initialKpiCs: KpiCsRecord[] = [
  {
    ...
    roleplay: 92,
    achievement: 98.4,
    notes: 'Outstanding compliance score in monthly audit. Active contributor to Telkomsel Halo migrations.',
    ranking: 1,
    progress: 98,
    target: 150,
    status: 'Excellent'
  },
  {
    ...
    roleplay: 90,
    achievement: 94.6,
    notes: 'High conversion rate on Indihome package speed upgrades.',
    ranking: 2,
    progress: 88,
    target: 150,
    status: 'Excellent'
  },
  {
    ...
    roleplay: 88,
    achievement: 91.2,
    notes: 'Consistent daily attendance and high ticket resolution speed.',
    ranking: 3,
    progress: 80,
    target: 150,
    status: 'Good'
  },
  {
    ...
    roleplay: 85,
    achievement: 87.5,
    notes: 'Needs to pitch Telkomsel Orbit product add-ons more consistently during billing queries.',
    ranking: 4,
    progress: 76,
    target: 150,
    status: 'Good'
  },
  {
    ...
    roleplay: 80,
    achievement: 79.8,
    notes: 'Good service level, though sales volume requires coaching in week 4.',
    ranking: 5,
    progress: 65,
    target: 150,
  ...
  },
  {
    ...
    roleplay: 78,
    achievement: 68.2,
    notes: 'Coaching plan initiated for product knowledge of Indihome high-speed packages.',
    ranking: 6,
    progress: 48,
    target: 150,
    status: 'Critical'
